...
Aplicación interactiva en p5.js y HTML para visualizar los principios de la evolución genética, la mutación y la selección artificial aplicados a estructuras morfológicas complejas.
...
2. Genera 6 Hijos a su alrededor, cada uno con mutaciones aleatorias en su ADN. Hay 14 gene en total: 5 para las longitudes dicotómicas, 3 para los ángulos y 5 para los colores de las ramificaciones.
